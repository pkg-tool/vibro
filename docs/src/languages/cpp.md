...
You can configure which `clangd` binary Vector should use.
...
If you want to disable Vector looking for a `clangd` binary, you can set `ignore_system_version` to `true`:
