...
// If the Vector binary doesn't use anything in this crate, it will be optimized away
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as VECTOR_COLUMN, VECTOR_FILE are gonna be the same as in the last execution of a task
