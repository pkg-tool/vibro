use crate::{
    ActiveDiagnostic, BlockId, COLUMNAR_SELECTION_MODIFIERS,
    ...
    HandleInput, InlayHintRefreshReason, InlineCompletion, JumpData, LineDown,
...
impl EditorElement {
    ...
    fn update_visible_cursor(
        ...
        let _ = (editor, point, position_map, window, cx);
    }
