...
Proto/proto3 (Protocol Buffers definition language) support is available through the [Proto extension](https://github.com/vector-editor/vector/tree/main/extensions/proto).
...
Or you can have Vector directly invoke `clang-format` by specifying it as a [formatter](https://vector.dev/docs/configuring-vector#formatter) in your settings:
