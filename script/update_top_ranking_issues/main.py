...
def main(
    ...
    repo_name: str = "vector-editor/vector"
...
def get_issue_text(
    ...
    issue_text_lines: list[str] = [
        ...
        *highest_ranking_issues_lines,
        "\n---\n",
        "*For details on how this issue is generated, [see the script](https://github.com/vector-editor/vector/blob/main/script/update_top_ranking_issues/main.py)*",
    ]
