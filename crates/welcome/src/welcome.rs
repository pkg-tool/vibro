...
pub const DOCS_URL: &str = "https://vector.dev/docs/";
                        ...
                        v_flex()
                            ...
                            .child(
                                h_flex()
                                    .w_full()
                                    .justify_center()
                                    .child(Headline::new("Welcome to Vector")),
                            )
                            .child(
                                            ...
                                            .on_click(cx.listener(|this, _, window, cx| {
                                                this.workspace
                                                    .update(cx, |_workspace, cx| {
                                                        window.dispatch_action(vector_actions::theme_selector::Toggle::default().boxed_clone(), cx);
                                                    })
                                                    .ok();
                                            })),
                                    )
                                ...
                                v_flex()
                                    ...
                                    .child(
                                        Button::new("explore-extensions", "Explore Extensions")
                                            ...
                                            .on_click(cx.listener(|_, _, window, cx| {
                                                window.dispatch_action(Box::new(
                                                    vector_actions::Extensions::default(),
                                                ), cx);
                                            })),
                                    )
                            ),
