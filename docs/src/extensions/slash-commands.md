...
To see a working example of an extension that provides slash commands, check out the [`slash-commands-example` extension](https://github.com/vector-editor/vector/tree/main/extensions/slash-commands-example).
