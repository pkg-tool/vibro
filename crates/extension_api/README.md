# The Vector Rust Extension API

This crate lets you write extensions for Vector in Rust.
...
Vector extensions are packaged as WebAssembly files. In your Cargo.toml, you'll
need to set your `crate-type` accordingly:

```toml
[dependencies]
vector_extension_api = "0.6.0"
...
To run your extension in Vector as you're developing it:
...
- Open the extensions view using the `vector: extensions` action in the command palette.
- Click the `Install Dev Extension` button in the top right
- Choose the path to your extension directory.

## Compatible Vector versions

Extensions created using newer versions of the Vector extension API won't be compatible with older versions of Vector.

Here is the compatibility of the `vector_extension_api` with versions of Vector:
