...
Scala language support in Vector is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-vector).
Report issues to: [https://github.com/scalameta/metals-vector/issues](https://github.com/scalameta/metals-vector/issues)
...
<!--
TBD: Provide LSP configuration example for metals in Vector settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
