...
Kotlin language support in Vector is provided by the community-maintained [Kotlin extension](https://github.com/vector-extensions/kotlin).
Report issues to: [https://github.com/vector-extensions/kotlin/issues](https://github.com/vector-extensions/kotlin/issues)
