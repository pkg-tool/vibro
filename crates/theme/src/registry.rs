...
impl ThemeRegistry {
    ...
    pub fn new(assets: Box<dyn AssetSource>) -> Self {
        ...
        // We're loading the Vector default theme, as we need a theme to be loaded
        // for tests.
        registry.insert_theme_families([crate::fallback_themes::vector_default_themes()]);
    ...
    /// Loads the themes bundled with the Vector binary and adds them to the registry.
