...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Vector Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Vector Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Vector Editor Preview Instance Running",
        ReleaseChannel::Stable => "Vector Editor Stable Instance Running",
    }
}
