...
Extensions may provide icon themes in order to change the icons Vector uses for folders and files.

## Example extension

The [Material Icon Theme](https://github.com/vector-extensions/material-icon-theme) serves as an example for the structure of an extension containing an icon theme.
...
Each icon theme file should adhere to the JSON schema specified at [`https://vector.dev/schema/icon_themes/v0.2.0.json`](https://vector.dev/schema/icon_themes/v0.2.0.json).

Here is an example of the structure of an icon theme:

```json
{
  "$schema": "https://vector.dev/schema/icon_themes/v0.2.0.json",
  "name": "My Icon Theme",
  "author": "Your Name",
  "themes": [
    {
