...
TOML support is available through the [TOML extension](https://github.com/vector-editor/vector/tree/main/extensions/toml).
...
Note: The taplo language server will not automatically pickup changes to `.taplo.toml`. You must manually trigger {#action editor::RestartLanguageServer} or reload Vector for it to pickup changes.
