...
Swift language support in Vector is provided by the community-maintained [Swift extension](https://github.com/vector-extensions/swift).
Report issues to: [https://github.com/vector-extensions/swift/issues](https://github.com/vector-extensions/swift/issues)
