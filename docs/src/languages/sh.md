...
Shell Scripts (bash, zsh, dash, sh) are supported natively by Vector.
...
Vector supports auto-formatting Shell Scripts using external tools like [`shfmt`](https://github.com/mvdan/sh).
...
- [Vector Docs: Language Support: Bash](./bash.md)
- [Vector Docs: Language Support: Fish](./fish.md)
