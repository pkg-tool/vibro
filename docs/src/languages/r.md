...
R support is available through the [R extension](https://github.com/ocsmit/vector-r).
...
3. Install the [R Vector extension](https://github.com/ocsmit/vector-r) through Vector's extensions manager.
...
To use the Vector REPL with R you need to install [Ark](https://github.com/posit-dev/ark), an R Kernel for Jupyter applications.
