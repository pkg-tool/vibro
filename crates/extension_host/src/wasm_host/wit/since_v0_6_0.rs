...
wasmtime::component::bindgen!({
    ...
    with: {
        ...
        "vector:extension/common": latest::vector::extension::common,
        ...
        "vector:extension/process": latest::vector::extension::process,
        "vector:extension/slash-command": latest::vector::extension::slash_command,
        "vector:extension/context-server": latest::vector::extension::context_server,
        "vector:extension/dap": latest::vector::extension::dap,
    },
});
