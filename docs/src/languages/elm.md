...
Elm support is available through the [Elm extension](https://github.com/vector-extensions/elm).
...
Vector support for Elm requires installation of `elm`, `elm-format`, and `elm-review`.
