...
HTML support is available through the [HTML extension](https://github.com/vector-editor/vector/tree/main/extensions/html).
...
By default Vector uses [Prettier](https://prettier.io/) for formatting HTML.

You can disable `format_on_save` by adding the following to your Vector `settings.json`:
...
To use the `vscode-html-language-server` language server auto-formatting instead of Prettier, add the following to your Vector settings:
...
You can customize various [formatting options](https://code.visualstudio.com/docs/languages/html#_formatting) for `vscode-html-language-server` via your Vector `settings.json`:
