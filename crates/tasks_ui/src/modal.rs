        ...
        fs.insert_tree(
            ...
            json!({
                ".vector": {
                    "tasks.json": r#"[
                        {
                            "label": "hello from $VECTOR_FILE:$VECTOR_ROW:$VECTOR_COLUMN",
                            "command": "echo",
                            "args": ["hello", "from", "$VECTOR_FILE", ":", "$VECTOR_ROW", ":", "$VECTOR_COLUMN"]
                        },
                        {
                            "label": "opened now: $VECTOR_WORKTREE_ROOT",
                            "command": "echo",
                            "args": ["opened", "now:", "$VECTOR_WORKTREE_ROOT"]
                        }
                    ]"#,
                },
            ...
            language_registry.add(Arc::new(
                ...
                .with_context_provider(Some(Arc::new(
                    ContextProviderWithTasks::new(TaskTemplates(vec![
                        ...
                        TaskTemplate {
                            label: "TypeScript task from file $VECTOR_FILE".to_string(),
                            command: "npm run build".to_string(),
                            ..TaskTemplate::default()
                        },
                        TaskTemplate {
                            label: "Another task from file $VECTOR_FILE".to_string(),
