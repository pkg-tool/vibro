...
Haskell support is available through the [Haskell extension](https://github.com/vector-extensions/haskell).
...
If you need to configure haskell-language-server (hls) you can add configuration options to your Vector settings.json:
