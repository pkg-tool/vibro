...
GPUI is still in active development as we work on the Vector code editor and isn't yet on crates.io. You'll also need to use the latest version of stable Rust and be on macOS or Linux. Add the following to your `Cargo.toml`:
...
Currently, the best way to learn about these APIs is to read the source code and examples. We're working on improving the documentation and adding more guides.
