# Vector Perplexity Extension

This example extension adds the `/perplexity` slash command to the Vector AI assistant.
...
1. Install the Rust toolchain and clone the Vector repo:
   ...
   mkdir -p ~/code
   cd ~/code
   git clone https://github.com/vector-editor/vector
   ```

1. Open Vector
1. Open Vector Extensions (`cmd-shift-x` / `ctrl-shift-x`)
1. Click "Install Dev Extension"
1. Navigate to the "extensions/perplexity" folder inside the Vector git repo.
