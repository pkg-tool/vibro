...
The snippets are located in `~/.config/vector/snippets` directory to which you can navigate to with the {#action snippets::OpenFolder} action.
...
For more configuration information, see the [`simple-completion-language-server` instructions](https://github.com/vector-editor/simple-completion-language-server/tree/main).
