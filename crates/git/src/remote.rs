...
mod tests {
    ...
    fn test_parsing_valid_remote_urls() {
        let valid_urls = vec![
            (
                "https://github.com/octocat/vector.git",
                "https",
                "github.com",
                "/octocat/vector.git",
            ),
            (
                "git@github.com:octocat/vector.git",
                "ssh",
                "github.com",
                "/octocat/vector.git",
            ),
            (
                "org-000000@github.com:octocat/vector.git",
                "ssh",
                "github.com",
                "/octocat/vector.git",
            ),
            (
                "ssh://git@github.com/octocat/vector.git",
                "ssh",
                "github.com",
                "/octocat/vector.git",
            ),
            (
                "file:///path/to/local/vector",
                "file",
                "",
                "/path/to/local/vector",
            ),
        ];
