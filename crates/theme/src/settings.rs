use crate::fallback_themes::vector_default_dark;
use crate::{
...
/// Note: This setting is still experimental. See [this tracking issue](https://github.com/vector-editor/vector/issues/18078)
...
pub struct ThemeSettingsContent {
    ...
    /// The name of the Vector theme to use.
    #[serde(default)]
    ...
    fn load(sources: SettingsSources<Self::FileContent>, cx: &mut App) -> Result<Self> {
        ...
        let mut this = Self {
            ...
            active_theme: themes
                ...
                .or(themes.get(&vector_default_dark().name))
                .unwrap(),
